       ...
       spinner1   = (Spinner) findViewById(R.id.spinnerSup);
        ...
        bmdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(bmInsert.this,
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, inputUrl,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String ServerResponse) {
                                ...
                                Toast.makeText(bmInsert.this, ServerResponse, Toast.LENGTH_LONG).show();
                            }
                        },
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError volleyError) {
                                ...
                                Toast.makeText(bmInsert.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                    ...
                    protected Map<String, String> getParams() {
                        ...
                        params.put("tglMasuk", dateHolder);
                        params.put("supplier", suupplierHolder);
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(bmInsert.this);
    ...
    private void loadNamaBarang(String url) {
        JsonObjectRequest bkRequest = new JsonObjectRequest(Request.Method.GET, url, null,new Response.Listener<JSONObject>(){
            ...
            public void onResponse(JSONObject response) {
                ...
                spinner.setAdapter(new ArrayAdapter<String>(bmInsert.this, android.R.layout.simple_spinner_dropdown_item, Namabarang));
            }
        }, new Response.ErrorListener() {
            @Override
